...
public class BuyDevelopCardAction extends Action {
     ...
     * @throws InvalidCardSlotException the specified develop card can't be placed in the specified slot
    ...
    public PhaseType performAction(IGameState gameState)
            ...
            InvalidUsernameException, NotBuyableException, InvalidCardSlotException,
