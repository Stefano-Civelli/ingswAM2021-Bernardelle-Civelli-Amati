...
public final class ConfigParameters {
  ...
  public static final InputStream cardConfigStream = ConfigParameters.class.getResourceAsStream("/configfiles/DevelopCardConfig.json");
  //public static final File leaderCardConfigFile;
  public static final InputStream leaderCardConfigStream;
  //public static final File trackConfigFile = new File("src/main/resources/configfiles/SquareConfig.json");
  public static final InputStream trackConfigStream = ConfigParameters.class.getResourceAsStream("/configfiles/SquareConfig.json");
  //public static final File lorenzoTrackConfigFile = ConfigParameters.trackConfigFile; // it may be different
  public static final InputStream lorenzoTrackConfigStream = ConfigParameters.trackConfigStream;
  ...
  static {
    if(TESTING) {
      ...
      leaderCardConfigStream = ConfigParameters.class.getResourceAsStream("/configfiles/LeaderCardConfig0Requirements.json");
    }
    else {
      //leaderCardConfigFile = new File("src/main/resources/configfiles/LeaderCardConfig.json");
      leaderCardConfigStream = ConfigParameters.class.getResourceAsStream("/configfiles/LeaderCardConfig.json");
    }
  }
